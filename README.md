...
Edit these constants at the top of `when.ts`:
...
Because it patches exported classes, a Pi release that restructures those components may stop showing stamps. Everything else in Pi keeps working.
